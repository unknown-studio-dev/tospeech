        ...
        ShadowingPracticeScaffold(
          ...
          transcript: {
            TranscriptNavigatorView(
              ...
              isCurrentPlaying: store.practice.phase == .listening)
          },
          sentence: {
            SentenceView(
              ...
              onTakeReview: { take in
                ...
                showingReview = true
              }, paceContext: lesson.sentences, onWord: { showWord($0) })
          },
          review: {
          ...
          supplementary: {
            if ProcessInfo.processInfo.arguments.contains("--preview-scenarios") {
              EchoDisclosureGroup("Preview scenarios", isExpanded: $showingScenarios) {
          ...
          transport: {
            PracticeTransportView(
              ...
              optionsPresented: $showingRepeatOptions)
          })
