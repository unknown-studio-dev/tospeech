...
enum TranscriptSource: String, Codable, Sendable {
  ...
  case appleSpeech
  /// Legacy value from the removed Whisper engine; retained so stored lessons decode.
  case whisper
  case parakeet
...
struct SegmentTimingRevisionDraft: Codable, Equatable, Sendable {
  ...
  var alignment: WordAlignmentEvidence? = nil
}
...
struct CaptionBaseline: Codable, Equatable, Sendable {
  ...
  func applying(
    ...
    alignment: WordAlignmentEvidence? = nil
  ) -> CaptionBaseline {
