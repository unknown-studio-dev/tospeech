...
enum EchoTheme {
  ...
  // Reference-speaker pace tints: warm for faster, cool for slower than the lesson median.
  static let paceFast = Color(hex: 0xF0A868)
  static let paceSlow = Color(hex: 0x6FB0F0)
