...
struct EchoUnsavedSheet: View {
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 16) {
      EchoLocalizedText("Giữ thay đổi timing?").font(EchoFont.heading(size: 22, weight: .semibold))
      EchoLocalizedText("Bạn đã chỉnh mốc câu này. Lưu thay đổi, bỏ phần chỉnh sửa, hoặc tiếp tục biên tập.")
