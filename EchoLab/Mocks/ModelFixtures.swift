...
enum ModelFixtures {
  static let packages = [
    ...
    ModelPackage(
      id: .gopt, subtitle: "Multi-level pronunciation assessment",
      footprint: "Acoustic pipeline and runtime size unverified",
      details:
        "Requires GOP features and an acoustic pipeline. RAM, latency and full bundle have not been measured. Installed is a preview fixture.",
      available: true, status: .installed),
    ModelPackage(
