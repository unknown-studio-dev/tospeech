...
struct BackendPaths: Equatable, Sendable {
  ...
  static var live: Self {
    ...
    return Self(
      root: applicationSupport.appendingPathComponent("EchoLab/Production", isDirectory: true))
  }

  var database: URL { root.appendingPathComponent("echolab.sqlite3") }
  ...
  func prepare(using fileManager: FileManager = .default) throws {
    for directory in [root, sourceAudio, thumbnails, takeStaging, finalTakes, packages, cache, importJobs] {
