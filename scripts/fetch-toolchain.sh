...
(
  ...
  xcrun swift "$ROOT/scripts/fix-macho-uuid.swift" qjs 4F3B9062-5B7B-4D9A-9499-BFD3EA1CA2B5
...
EchoLab bundles FFmpeg 9.0.1 built from source under LGPL-2.1-or-later.
The exact source archive, SHA-256, and build configuration are in Toolchain.lock.json.
